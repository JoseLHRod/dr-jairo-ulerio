            ...
            switch ($action) {
                ...
                case 'proposal_comment':
                    ...
                    if (!$this->input->post('content')) {
                        echo '<script>window.location.href = "'.base_url($this->uri->uri_string()).'";</script>';
                    }
                    $data               = $this->input->post();
                    $data['proposalid'] = $id;
                    $this->proposals_model->add_comment($data, true);
                    echo '<script>window.location.href = "'.base_url($this->uri->uri_string()).'?tab=discussion'.'";</script>';
