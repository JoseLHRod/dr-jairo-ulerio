...
class App_Lang extends MX_Lang
{
    ...
    public function load($langfile, $lang = '', $return = false, $add_suffix = true, $alt_path = '', $_module = '')
    {
        ...
        list($path, $_langfile) = Modules::find($idiom . '_lang', $_module, 'language/' . $idiom . '/');

        if ($path === false) {
            if ($lang = parent::load($idiom, $lang, $return, $add_suffix, $alt_path)) {
                return $lang;
            }
        } else {
            if ($lang = Modules::load_file($_langfile, $path, 'lang')) {
                ...
                $this->is_loaded[]    = $idiom . '_lang' . EXT;
                unset($lang);
            }
        }
