    ...
    public function update_client_status($data)
    {
        ...
        if ($this->db->affected_rows() > 0) {
            ...
            if ($current_status != $old_status && $old_status != '') {
                $_log_message    = 'not_client_activity_status_updated';
        ...
        if ($affectedRows > 0) {
            ...
            $this->log_client_activity($data['leadid'], $_log_message, false, $additional_data);
