				...
				<div class="panel_s">
					<div class="panel-body">
							...
							<div class="col-md-12 mtop30">
								<div class="row">
									<div class="col-md-6">
										...
										<?php } ?>
                                        <hr />
										<p>Subtotal <span class="pull-right bold"><?php echo app_format_money($payment->invoice->subtotal, $payment->invoice->currency_name); ?></span></p>
                                        <hr />
										<p>Discounts <span class="pull-right bold"><?php echo app_format_money($payment->invoice->paymentamount, $payment->invoice->currency_name); ?></span></p>
									</div>
									<div class="clearfix"></div>
									<div class="col-md-6">
                        ...
                        <div class="table-responsive s_table">
                           <table class="table items has-calculations no-mtop">
                              <thead>
                                 <tr>
                                    <th width="60%" align="left"><?php echo _l('invoice_table_item_heading'); ?></th>
                                    <?php
                              ...
                              <tbody>
                                 <?php if (isset($invoice) || isset($add_items)) {
                                       ...
                                       foreach ($add_items as $item) {
                                          ...
                                          $table_row .= '<td class="bold description">' . clear_textarea_breaks($item['description']) . '<br />';
                                          $table_row .= '<span style="font-weight: 300; font-size: 12px;">'.clear_textarea_breaks($item['long_description']) . '</span></td>';
                                          $table_row .= '<td align="right">'.$item['qty'].'</td>';
                                          $amount = app_format_money($item['rate'], $payment->invoice->currency_name);
                                          $table_row .= '<td align="right">' . $amount . '</td>';
                                          $table_row .= '</tr>';
                                          echo $table_row;
                                          $i++;
                                       }
							...
							<div class="col-md-12 mtop30">
								...
								<div class="table-responsive">
									...
									<div class="col-md-12 mtop30">
										...
										<div><?php echo $payment->invoice->terms; ?></div>
									</div>
								</div>
							</div>
