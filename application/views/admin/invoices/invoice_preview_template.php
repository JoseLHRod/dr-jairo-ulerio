      ...
      <div class="panel-body">
         ...
         <div class="row mtop10">
            ...
            <div class="col-md-9 _buttons">
               ...
               <a href="#" data-toggle="tooltip" title="Record Payment" class="invoice-send-to-record-payment btn btn-default btn-with-tooltip" data-placement="bottom" <?php if($invoice->status != 7 && $invoice->status != 8){}else{echo 'style="pointer-events: none; display: inline-block;" disabled';} ?>><span data-toggle="tooltip"><i class="fa fa-upload" aria-hidden="true"></i></span></a>
               <a href="#" data-toggle="tooltip" title="View Record Payment" class="invoice-view-record-payment btn btn-default btn-with-tooltip" data-placement="bottom" <?php if($invoice->status == 8){}else{echo 'style="pointer-events: none; display: inline-block;" disabled';} ?>><span data-toggle="tooltip"><i class="fa fa-picture-o" aria-hidden="true"></i></span></a>
               <?php
...
<?php $this->load->view('admin/invoices/invoice_send_to_record_payment'); ?>
<?php $this->load->view('admin/invoices/invoice_view_record_payment'); ?>
...
<script>
   $("body").on("click",".invoice-send-to-record-payment",function(e){
      e.preventDefault();
      $("#invoice_send_to_record_payment_modal").modal("show");
   });
   $("body").on("click",".invoice-view-record-payment",function(e){
      e.preventDefault();
      $("#invoice_view_record_payment_modal").modal("show");
   });
</script>
<script>
