               ...
               <div class="panel-body">
                  <div class="row">
                     ...
                     <div class="col-md-6 border-right">
                        ...
                        <div class="form-group mtop10 no-mbot">
                          <label for="template_mail_id" class="control-label"><?php echo 'Mail Template' ?></label>
                          <select required id="template_mail_id" name="template_mail_id" class="selectpicker" data-width="100%" <?php echo $disabled; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                            <?php foreach($proposals_mails as $mails){ ?>
                              <?php if($mails['show_on_proposal'] == 0) { continue; } ?>
                                <option value="<?php echo $mails['emailtemplateid']; ?>"<?php echo (isset($proposal->mail_templateid) ? $proposal->mail_templateid : false) == $mails['emailtemplateid'] ? 'selected' : ''; ?>><?php echo $mails['name']; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                     </div>
                           ...
                           <div class="col-md-6">
                              <?php
                                 ...
                                 foreach($staff as $member){
                                  ...
                                  }else $selected = get_staff_user_id();
                                  $i++;
                                 }
...
<script>
   ...
   $(function(){
    init_currency();
    // Maybe items ajax search template_mail_id
