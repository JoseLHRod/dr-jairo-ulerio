...
$statuses              = $this->ci->leads_model->get_status('', ['statustype' => 'leads']);
...
$join = [
    ...
    'LEFT JOIN ' . db_prefix() . 'leads_status ON ' . db_prefix() . 'leads_status.id = ' . db_prefix() . 'leads.status and '. db_prefix() . "leads_status.statustype = 'leads'",
