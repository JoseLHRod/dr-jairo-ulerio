            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="_buttons">
                     ...
                     <a href="<?php echo base_url('clinicHistory'); ?>" class="btn btn-info mright5 test pull-left display-block">
...
<?php init_tail(); ?>
<script>
   function client_mark_as(status_id, lead_id) {
      var data = {};
      data.status = status_id;
      data.leadid = lead_id;
      
      $.post(admin_url + 'patients/update_patient_status', data).done(function(response) {
