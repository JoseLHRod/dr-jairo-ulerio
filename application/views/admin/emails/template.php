         ...
         <div class="col-md-6">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <?= render_input('name', 'template_name', $template->name, 'text', array('disabled' => true)); ?>
                        ...
                        <?= render_textarea(
                           ...
                           '',
                           $template->message,
                           array('data-url-converter-callback' => 'myCustomURLConverter'),
                           array(),
                           '',
                        ...
                        <?php foreach ($available_languages as $availableLanguage) {
                           ...
                           if (count($lang_template) > 0) {
                              $lang_used = false;
                              if (
                                 get_option('active_language') == $availableLanguage ||
                                 total_rows(db_prefix() . 'staff', array('default_language' => $availableLanguage)) > 0 ||
                                 total_rows(db_prefix() . 'clients', array('default_language' => $availableLanguage)) > 0
                              ) {
                                 $lang_used = true;
                              }
                              $hide_template_class = '';
