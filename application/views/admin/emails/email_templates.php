                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 email-template-title">
                            ...
                            <div class="col-md-12">
                                <h4 class="bold well email-template-heading">
                                    ...
                                    <?php if ($hasPermissionEdit) { ?>
                                        ...
                                        <a href="<?php echo admin_url('emails/add/proposals'); ?>" class="pull-right mright5"><small class="text-primary"><?php echo _l('email_templates_add_template'); ?></small></a>
                                    <?php } ?>
                                            ...
                                            <?php foreach ($proposals as $proposal_template) { ?>
                                                <tr>
                                                    <td class="<?php if ($proposal_template['active'] == 0) {
                                                        ...
                                                        <?php } ?>
                                                        <?php if ($hasPermissionEdit) { ?>
                                                            <a href="<?php echo admin_url('emails/' . ($proposal_template['active'] == '1' ? 'disable/' : 'enable/') . $proposal_template['emailtemplateid']); ?>" class="pull-right" style="margin-left: 10px"><small><?php echo _l($proposal_template['active'] == 1 ? 'disable' : 'enable'); ?></small></a>
                                                            <a href="<?php echo admin_url('emails/' . ($proposal_template['show_on_proposal'] == 1 ? 'remove_from_proposal/' : 'add_to_proposal/') . $proposal_template['emailtemplateid']); ?>" class="pull-right" style="margin-left: 10px"><small><?php echo _l($proposal_template['show_on_proposal'] == 1 ? 'Remove from proposals' : 'Add to proposals'); ?></small></a>
                                                        <?php } ?>
                                                        <?php if ($hasPermissionEdit && $proposal_template['emailtemplateid'] > 2000) { ?>
                                                            <a href="<?php echo admin_url('emails/delete/') . $proposal_template['emailtemplateid']; ?>" class="pull-right"><small><?php echo 'Delete'; ?></small></a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                            ...
                            <div class="col-md-12">
                                <h4 class="bold well email-template-heading">
                                    ...
                                    <?php if ($hasPermissionEdit) { ?>
                                        ...
                                        <a href="<?php echo admin_url('emails/enable_by_type/leads'); ?>" class="pull-right mleft5"><small><?php echo _l('enable_all'); ?></small></a>
                                        <a href="<?php echo admin_url('emails/add/leads'); ?>" class="pull-right"><small class="text-primary"><?php echo _l('email_templates_add_template'); ?></small></a>
                                    <?php } ?>
                            ...
                            <?php hooks()->do_action('before_mailbox_email_templates'); ?>
                            <div class="col-md-12">
                                <h4 class="bold well email-template-heading">
                                    <?php echo _l('mailbox'); ?>
                                    <?php if ($hasPermissionEdit) { ?>
                                        <a href="<?php echo admin_url('emails/disable_by_type/mailbox'); ?>" class="pull-right mleft5 mright25"><small><?php echo _l('disable_all'); ?></small></a>
                                        <a href="<?php echo admin_url('emails/enable_by_type/mailbox'); ?>" class="pull-right mleft5"><small><?php echo _l('enable_all'); ?></small></a>
                                        <a href="<?php echo admin_url('emails/add/mailbox'); ?>" class="pull-right"><small class="text-primary"><?php echo _l('email_templates_add_template'); ?></small></a>
                                    <?php } ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php foreach ($mailboxs as $mailbox_template) { ?>
                                                <tr>
                                                    <td class="<?php if ($mailbox_template['active'] == 0) {
                                                                    echo 'text-throught';
                                                                } ?>">
                                                        <a href="<?php echo admin_url('emails/email_template/' . $mailbox_template['emailtemplateid']); ?>"><?php echo $mailbox_template['name']; ?></a>
                                                        <?php if (ENVIRONMENT !== 'production') { ?>
                                                            <br /><small><?php echo $mailbox_template['slug']; ?></small>
                                                        <?php } ?>
                                                        <?php if ($hasPermissionEdit) { ?>
                                                            <a href="<?php echo admin_url('emails/' . ($mailbox_template['active'] == '1' ? 'disable/' : 'enable/') . $mailbox_template['emailtemplateid']); ?>" class="pull-right"><small><?php echo _l($mailbox_template['active'] == 1 ? 'disable' : 'enable'); ?></small></a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
