  ...
  <div class="row">
   ...
   <div class="top-lead-menu">
      ...
      <ul class="nav-tabs-horizontal nav nav-tabs<?php if(!isset($lead)){echo ' lead-new';} ?>" role="tablist">
         ...
         <?php } ?>
         <li role="presentation">
            <a href="#lead_appointments" onclick="initDataTable('.table-lead-appointments', admin_url + 'appointly/appointments/table_appointly/<?php echo $lead->id; ?>', undefined, undefined, undefined, [6,'desc']);" aria-controls="lead_appointments" role="tab" data-toggle="tab">
   ...
   <div class="tab-content mtop20">
      ...
      <div role="tabpanel" class="tab-pane" id="lead_appointments">
         ...
         <a href="<?php echo admin_url(); ?>appointly/appointments" class="btn btn-info"><?php echo _l('appointment_new_appointment'); ?></a>
         <hr />
         <?php 
