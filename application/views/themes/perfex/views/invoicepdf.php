...
if ((int) $invoice->payment_deposited == 1) {
    $tbltotal .= '
    <tr style="background-color:#f0f0f0;">
        <td align="right" width="85%"><strong>Payment Deposited</strong></td>
        <td align="right" width="15%">-' . app_format_money($invoice->paymentamount, $invoice->currency_name) . '</td>
    </tr>';
}
