...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var webmailTableNotSortable = [0, 1, 2, 3];
        ...
        const table = $('.table-mailbox').DataTable();
        table.columns([0,1,2,3]).visible(true);
        $('.table-mailbox th').addClass('all');
        
        $('.table-mailbox').on('xhr.dt', function() {
            //$('.table-mailbox thead th:eq(2)').width('100');
        })
    });
</script>
</body>
